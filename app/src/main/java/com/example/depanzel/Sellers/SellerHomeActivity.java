...
import com.example.depanzel.Admin.AdminCheckNewProductsActivity;
import com.example.depanzel.Buyers.MainActivity;
import com.example.depanzel.Model.Products;
import com.example.depanzel.R;
import com.example.depanzel.ViewHolder.ItemViewHolder;
import com.example.depanzel.ViewHolder.ProductViewHolder;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId())
            {
                ...
                case R.id.navigation_add:
                    Intent intentCate = new Intent(SellerHomeActivity.this, SellerProductsCategoryActivity.class);
        ...
        FirebaseRecyclerAdapter<Products, ItemViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ItemViewHolder>(options)
                {
                    ...
                    protected void onBindViewHolder(@NonNull ItemViewHolder holder, int position, @NonNull Products model) {
                        ...
                        holder.txtProductDescription.setText("State : " + model.getDescription());
