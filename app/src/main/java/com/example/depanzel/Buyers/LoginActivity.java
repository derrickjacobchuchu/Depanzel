...
import com.example.depanzel.Admin.AdminHomeActivity;
import com.example.depanzel.Sellers.SellerProductsCategoryActivity;
                ...
                if (dataSnapshot.child(parentDbName).child(phone).exists())
                {
                    ...
                    if (usersData.getPhone().equals(phone))
                    {
                        if (usersData.getPassword().equals(password))
                        {
                          ...
                          {
                              Toast.makeText(LoginActivity.this, "Weilcome Admin, you are logged in Successfully", Toast.LENGTH_SHORT).show();
                              loadingBar.dismiss();
