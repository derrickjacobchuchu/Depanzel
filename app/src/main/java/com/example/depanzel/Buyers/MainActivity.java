...
import com.example.depanzel.Model.Users;
import com.example.depanzel.Prevalent.Prevalent;
import com.example.depanzel.R;
import com.example.depanzel.Sellers.SellerHomeActivity;
import com.example.depanzel.Sellers.SellerRegistrationActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sellerBegin.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.child("Users").child(phone).exists())
                {
                    ...
                    if (usersData.getPhone().equals(phone))
                    {
                        ...
                        {
                            Toast.makeText(MainActivity.this, "Please eait, you are already logged in.", Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
